...
endpointGroup.MapPatch("reply/", [Authorize(Roles = "Doctor")] async (ReplyAppointmentInput replyAppointment, IAppointmentService appointmentService) =>
{
...
endpointGroup.MapPatch("cancel/", [Authorize(Roles = "Patient")] async (CancelAppointmentInput cancelAppointment, IAppointmentService appointmentService) =>
{
